...
>(
  (
    ...
    return (
      <aside
        ref={ref}
        className={cn("group hidden md:block text-foreground h-full", className)}
        data-state={state}
      ...
      >
        ...
        <div
          className={cn(
            "duration-200 fixed inset-y-0 z-40 hidden h-full transition-[left,right,width] ease-linear md:flex",
             "w-[--sidebar-width]",
            side === "left"
